    ...
    public class ProductDetail extends AppCompatActivity {
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            name = findViewById(R.id.nameFoods);
             details = findViewById(R.id.detailFoods);
             price = findViewById(R.id.priceFoods);
             quantity = findViewById(R.id.quantityFoods);
            image = findViewById(R.id.imageFoods);
            ...
            String query = "SELECT * FROM Foods WHERE id = " + productId;
    ...
    // Chuyển đổi chuỗi thành giá trị double
                    ...
                    if (database.checkProductExist(checkProductName)) {
                        ...
                        String query = "SELECT Image FROM Foods WHERE id = " + productId;
                        Cursor dataClothes = database.GetData(query);
